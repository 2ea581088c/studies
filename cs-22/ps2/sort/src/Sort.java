...
public class Sort {
    ...
    /*
    removeDups - takes a sorted array of integers and removes duplicate elements
    The remaining elements should still be sorted, and they should occupy the leftmost positions of the array.
    The array locations that are unused after the duplicates are removed should be filled with zeroes.
    The method should return an int that specifies the number of unique values in the array
    */
