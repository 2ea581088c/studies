...
public class SortCount {
    ...
    /**
     * swapSort - swap sort compares pairs of elements and swaps them when they are out of order,
     * but swap sort looks at different pairs of elements than bubble sort does. On pass i of swap sort,
     * the element in position i of the array is compared with the elements in all positions to the right
     * of position i, and pairs of elements are swapped as needed. At the end of pass i, the element in
     * position i is where it belongs in the sorted array.
     */
   ...
   /**
    ...
    public static void main(String args[]) {
        ...
        // O(n^2) overall complexity, no of comparisons is fixed while no of moves varies depending on how sorted
